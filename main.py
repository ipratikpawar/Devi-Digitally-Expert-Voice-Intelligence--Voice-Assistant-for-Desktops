...
a = {'DEVI':'virtualbysakshi@gmail.com'}
...
def wishme():
    ...
    if hour >= 0 and hour <= 12:
        ...
        window.update()
        speak("Good Evening !")
    speak("Myself DEVI! How may I help you ") 
...
def play():
    ...
    while True:
        ...
        if 'exit' in query:
            ...
            var.set('Hello I am Digitally Expert Voice Assistant but u can call me DEVI ')
            window.update()
            speak("Hello I am Digitally Expert Voice Assistant but u can call me DEVI.")

        elif 'play music' in query:
            var.set('Name the song')
            window.update()
            speak('name the song')
            command=query[11:]
            strr=command.replace(" ","-")
            ...
            var.set("Myself Digitally Expert Voice Assistant but u can call me DEVI.")
            window.update()
            speak('myself Digitally Expert Voice Assistant but u can call me DEVI.')
...
def mainwindow():
    label2 = Label(window, textvariable = var1, bg = '#808080')
    ...
    global btn0 
    btn0= Button(text = 'WISH ME',width = 20, command = wishme, bg = '#E6E6FA')
    btn0.config(font=("Courier", 12))
    btn0.pack()
    global btn1
    btn1 = Button(text = 'START',width = 20,command = play, bg = '#E6E6FA')
    btn1.config(font=("Courier", 12))
    btn1.pack()
    global btn2
    btn2 = Button(text = 'EXIT',width = 20, command = window.destroy, bg = '#E6E6FA')
    btn2.config(font=("Courier", 12))
    btn2.pack()
    global btn3
    btn3 = Button(text = 'ADD Command',width = 20, command = run, bg = '#E6E6FA')
